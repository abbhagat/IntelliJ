...
class LinkedHashMapDemo<K, V> {
    ...
    /**
     * Method allows you put key-value pair in LinkedHashMapCustom. If the map
     * already contains a mapping for the key, the old value is replaced. Note:
     * method does not allows you to put null key thought it allows null values.
