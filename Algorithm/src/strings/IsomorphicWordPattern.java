 ...
 * Ex 1: Input: pattern = "abba", str = "dog cat cat dog"  Output: true
 * Ex 2: Input:pattern = "abba",  str = "dog cat cat fish" Output: false
 * Ex 3: Input: pattern = "aaaa", str = "dog cat cat dog"  Output: false
 * Ex 4: Input: pattern = "abba", str = "dog dog dog dog"  Output: false
 */
