 ...
 * Initialize a variable result as 0 to store the required result.
 ...
 * If true, then update result to mid and search in the right part of mid by updating l to mid+1. Otherwise, update the value of r to mid-1.
