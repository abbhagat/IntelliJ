...
INSERT INTO EMPLOYEE VALUES(9 ,'Rajitha' , 100000 ,'Lingampally' ,'01-JAN-1972' ,'02-FEB-2008' ,'Project Lead' , 9 , NULL ,'F');

INSERT INTO EMPLOYEE VALUES(10 ,'Phani' , 100000 ,'Lingampally' ,'01-JAN-1972' ,'02-FEB-2008' ,'Project Lead' , 9 , NULL ,'F');
...
SELECT GENDER, LISTAGG(EMP_NAME, ', ')"Names" FROM EMPLOYEE GROUP BY GENDER;

SELECT GENDER, LISTAGG(EMP_NAME, ', ') WITHIN GROUP (ORDER BY EMP_NAME) "Names" FROM   EMPLOYEE GROUP BY GENDER;

SELECT GENDER, COUNT(GENDER) FROM EMPLOYEE GROUP BY GENDER;

SELECT GENDER, LISTAGG(EMP_NAME, ', ')"Names", COUNT(GENDER) FROM EMPLOYEE GROUP BY GENDER;
...
SELECT LPAD(E1.EMP_NAME,15,'*') ||' reports to ' || RPAD(E2.EMP_NAME,10,'#')
FROM  EMPLOYEE E1 , EMPLOYEE E2
...
CREATE TABLE EMP (ID INTEGER , NAME VARCHAR2(20));
...
DELETE FROM EMPLOYEE A WHERE ROWID <(SELECT MIN(ROWID) FROM EMPLOYEE B WHERE A.EMP_NAME = B.EMP_NAME);
...
SELECT COUNT(*) FROM EMPLOYEE WHERE MGR_ID=(SELECT EMP_ID FROM EMPLOYEE WHERE EMP_NAME='&MGR');
...
--DISPLAY THE TOTAL NUMBER OF EMPLOYEE WORKING UNDER MANAGER 'Naseer'
SELECT  MGR_ID, COUNT(MGR_ID) FROM EMPLOYEE WHERE  MGR_ID = (SELECT MGR_ID FROM EMPLOYEE WHERE EMP_NAME = 'Naseer') GROUP BY MGR_ID;
...
ALTER TABLE B DROP CONSTRAINT SYS_C008322;

ALTER TABLE B DROP CONSTRAINT SYS_C008324;
...
SELECT TO_CHAR((DOJ+SALARY),'DD-MON-YYYY')"Date" FROM EMPLOYEE;
